...
exports.run = async (client, message, args) => {
  ...
  if (altın < elmaspara * miktar) {
    message.channel.send(
      `:no_entry: ${miktar} elmas alabilmek için yeterli altın görünmüyor. \n Gerekli altın **${miktar *
        elmaspara} **`
    );
    ...
    const aldıE2 = new Discord.RichEmbed()
      ...
      .setDescription(
        ...
        )} Başarıyla marketten **${miktar}** elmas aldınız\n Hesabınızdan eksilen altın miktarı: **${miktar *
          elmaspara}**`
      )
      .setTimestamp();
