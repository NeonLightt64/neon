    ...
    if (!x) {
      ...
      const e2 = new Discord.RichEmbed()
        ...
        .addField(
          `Mesleğin:`,
          `Çalıştığı meslek: ${
            meslekA === null ? "Bir meslekte çalışmıyorsunuz" : `${meslekA}`
          }`
        )
        .setTimestamp();
    ...
    if (x === "madenci") {
      if (meslek > 0) {
        message.channel.send(
          `${client.emojis.get(
            client.emojiler.hayır
          )} Sen bu mesleği önceden olmuşsun zaten.`
        );
      } else if (meslek > 0) {
        ...
        message.channel.send(
          `${client.emojis.get(
            client.emojiler.hayır
          )} Madenci olmak için yeterli paran bulunuyor. \n Gerekli olan para: **1000TL**.`
        );
      } else if (para > 1000) {
        const madenciE = new Discord.RichEmbed()
          ...
          .setDescription(
            ...
            )} Yeni mesleğiniz **madenci**\n${client.emojis.get(
              client.emojiler.konfeti
    ...
    if (x === "çiftçi") {
      ...
      if (meslek < 1) {
        ...
        message.channel.send(
          `${client.emojis.get(
            client.emojiler.hayır
          )} Çiftçi olmak için yeterli paran bulunuyor. \n Gerekli olan para: **2000TL**.`
        );
      } else if (para > 2000) {
        const madenciE = new Discord.RichEmbed()
          .setColor("RANDOM")
    ...
    if (x === "tamirci") {
      ...
      if (meslek < 302) {
        ...
        message.channel.send(
          `${client.emojis.get(
            client.emojiler.hayır
          )} tamirci olmak için yeterli paran bulunuyor. \n Gerekli olan para: **3000TL**.`
        );
      } else if (para > 3000) {
        const madenciE = new Discord.RichEmbed()
          .setColor("RANDOM")
    ...
    if (x === "emlakçı") {
      ...
      if (meslek < 302) {
        ...
        message.channel.send(
          `${client.emojis.get(
            client.emojiler.hayır
          )} emlakçı olmak için yeterli paran bulunuyor. \n Gerekli olan para: **5000TL**.`
        );
      } else if (para > 5000) {
    ...
    if (x === "mimar") {
      ...
      if (meslek < 302) {
        ...
        message.channel.send(
          `${client.emojis.get(
            client.emojiler.hayır
          )} mimar olmak için yeterli paran bulunuyor. \n Gerekli olan para: **10000TL**.`
        );
      } else if (para > 10000) {
    ...
    if (x === "doktor") {
      ...
      if (meslek < 302) {
        ...
        message.channel.send(
          `${client.emojis.get(
            client.emojiler.hayır
          )} doktor olmak için yeterli paran bulunuyor. \n Gerekli olan para: **20000TL**.`
        );
      } else if (para > 20000) {
