...
exports.run = async (client, message, args) => {
  ...
  if (!kanal) {
    var embedd = new Discord.RichEmbed()
      .setDescription(
        `Lütfen sunucuya katılan kişilerin isimlerinin başına eklenecek tagı yazınız.`
      )
      .setColor("RANDOM");
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setDescription(
      `Tag Kayıtları kanalı ${kanal} olarak ayarlandı.\nKapatmak İçin: ${prefix}tagkanal kapat.`
    );
